...
function highlightSkills() {
  ...
  const accordionOne = document.getElementById("headingOne").firstElementChild.getAttribute("aria-expanded");
  const accordionTwo = document.getElementById("headingTwo").firstElementChild.getAttribute("aria-expanded");
  const accordionThree = document.getElementById("headingThree").firstElementChild.getAttribute("aria-expanded");
