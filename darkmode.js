...
function darkMode() {
    ...
    if (currentMode.includes("bg-light")) {
        ...
        navBar.setAttribute("class","navbar navbar-expand-lg navbar-dark border-bottom")
        ...
        navBar.setAttribute("class","navbar navbar-expand-lg navbar-light border-bottom")
